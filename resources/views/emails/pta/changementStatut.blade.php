...
<div class="content">
    ...
    <div class="contenu" style="color: #718096;">
        ...
        @if($details['type'] == 'activite')

            <p>
                L'activité : {{$details['nom']}}, code PTA : {{$details['codePta']}} a changé de statut: {{$details['statut']}}
            </p>
        @else
            <p>
                La tache : {{$details['nom']}}, code PTA : {{$details['codePta']}} a changé de statut: {{$details['statut']}}
            </p>
        @endif
