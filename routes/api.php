...
// =============================================================================
// HEALTH CHECK ENDPOINTS (Public - for external monitoring)
// =============================================================================
...
Route::group(['middleware' => ['cors', 'json.response'], 'as' => 'api.' /* , 'namespace' => 'App\Http\Controllers' */], function () {
    ...
    Route::group(['middleware' => [/* 'deconnexion', */ 'auth:sanctum' /* , 'cookie' */]], function () {
        ...
        Route::group(['prefix' => 'gfa', 'as' => 'gfa.'], function () {
            ...
            Route::apiResource('indicateur-value-keys', 'IndicateurValueKeyController', ['except' => ['index']])
                ->names('indicateur-value-keys')
                ->parameters([
                    'indicateur-value-keys' => 'indicateur_value_key',
                ])
                ->middleware(['role:unitee-de-gestion']);

            Route::apiResource('indicateur-value-keys', 'IndicateurValueKeyController', ['only' => ['index']])
                ->names('indicateur-value-keys')
                ->parameters([
                    'indicateur-value-keys' => 'indicateur_value_key',
                ]);
            ...
            Route::apiResource('types-de-gouvernance', 'TypeDeGouvernanceController')
                ->names('types-de-gouvernance')
                ->parameters([
            ...
            Route::apiResource('principes-de-gouvernance', 'PrincipeDeGouvernanceController')
                ->names('principes-de-gouvernance')
                ->parameters([
            ...
            Route::apiResource('criteres-de-gouvernance', 'CritereDeGouvernanceController')
                ->names('criteres-de-gouvernance')
                ->parameters([
            ...
            Route::apiResource('indicateurs-de-gouvernance', 'IndicateurDeGouvernanceController')
                ->names('indicateurs-de-gouvernance')
                ->parameters([
                    'indicateurs-de-gouvernance' => 'indicateur_de_gouvernance',
                ]);

            Route::apiResource('questions-operationnelle', 'IndicateurDeGouvernanceController')
                ->names('questions-operationnelle')
                ->parameters([
            ...
            Route::apiResource('options-de-reponse', 'OptionDeReponseController')
                ->names('options-de-reponse')
                ->parameters([
            ...
            Route::apiResource('fonds', 'FondController')
                ->names('fonds')
                ->parameters([
                    'fonds' => 'fond',
                ]);
            ...
            Route::apiResource('actions-a-mener', 'ActionAMenerController')
                ->names('actions-a-mener')
                ->parameters([
            ...
            Route::apiResource('formulaires-de-gouvernance', 'FormulaireDeGouvernanceController')
                ->names('formulaires-de-gouvernance')
                ->parameters([
                    'formulaires-de-gouvernance' => 'formulaire_de_gouvernance',
                ]);

            Route::apiResource('evaluations-de-gouvernance', 'EvaluationDeGouvernanceController')
                ->names('evaluations-de-gouvernance')
                ->parameters([
            ...
            Route::apiResource('survey-forms', 'SurveyFormController')
                ->names('survey-forms')
                ->parameters([
            ...
            Route::apiResource('survey-reponses', 'SurveyReponseController', ['except' => ['update']])
                ->names('survey-reponses')
                ->parameters([
    ...
    Route::group(['prefix' => 'gfa', 'as' => 'gfa.'], function () {
        Route::group(['prefix' => 'enquete-de-gouvernance', 'as' => 'enquetes-de-gouvernance.', 'namespace' => 'enquetes_de_gouvernance'], function () {
            Route::group(['middleware' => ['auth:sanctum']], function () {
                Route::apiResource('types-de-gouvernance-factuel', 'TypeDeGouvernanceFactuelController')
                    ->names('types-de-gouvernance-factuel')
                    ->parameters([
                ...
                Route::apiResource('principes-de-gouvernance-factuel', 'PrincipeDeGouvernanceFactuelController')
                    ->names('principes-de-gouvernance-factuel')
                    ->parameters([
                        'principes-de-gouvernance-factuel' => 'principe_de_gouvernance_factuel',
                    ]);

                Route::apiResource('principes-de-gouvernance-de-perception', 'PrincipeDeGouvernancePerceptionController')
                    ->names('principes-de-gouvernance-de-perception')
                    ->parameters([
                        'principes-de-gouvernance-de-perception' => 'principe_de_perception',
                    ]);

                Route::apiResource('criteres-de-gouvernance-factuel', 'CritereDeGouvernanceFactuelController')
                    ->names('criteres-de-gouvernance-factuel')
                    ->parameters([
                        'criteres-de-gouvernance-factuel' => 'critere_de_gouvernance_factuel',
                    ]);

                Route::apiResource('indicateurs-de-gouvernance-factuel', 'IndicateurDeGouvernanceFactuelController')
                    ->names('indicateurs-de-gouvernance-factuel')
                    ->parameters([
                        'indicateurs-de-gouvernance-factuel' => 'indicateur_factuel',
                    ]);

                Route::apiResource('questions-operationnelle', 'QuestionOperationnelleController')
                    ->names('questions-operationnelle')
                    ->parameters([
                        'questions-operationnelle' => 'question_operationnelle',
                    ]);

                Route::apiResource('options-de-reponse-gouvernance', 'OptionDeReponseGouvernanceController')
                    ->names('options-de-reponse-gouvernance')
                    ->parameters([
                ...
                Route::apiResource('sources-de-verification', 'SourceDeVerificationController')
                    ->names('sources-de-verification')
                    ->parameters([
                        'sources-de-verification' => 'source_de_verification',
                    ]);

                Route::apiResource('formulaires-de-perception-de-gouvernance', 'FormulaireDePerceptionDeGouvernanceController')
                    ->names('formulaires-de-perception-de-gouvernance')
                    ->parameters([
                        'formulaires-de-perception-de-gouvernance' => 'formulaire_de_perception',
                    ]);

                Route::apiResource('formulaires-factuel-de-gouvernance', 'FormulaireFactuelDeGouvernanceController')
                    ->names('formulaires-factuel-de-gouvernance')
                    ->parameters([
...
function generateResultForPerceptionEvaluation(EvaluationGouvernance $evaluation, FormulaireDePerceptionDeGouvernance $formulaireDeGouvernance, $organisationId)
{
    ...
    $results_categories_de_gouvernance = $formulaireDeGouvernance->categories_de_gouvernance()->with('questions_de_gouvernance.reponses')->get()->each(function ($categorie_de_gouvernance) use ($evaluationId, $organisationId, $options_de_reponse, &$principes_de_gouvernance) {
        $categorie_de_gouvernance->questions_de_gouvernance->load(['reponses' => function ($query) use ($evaluationId, $organisationId) {
            ...
            $counts = $question_de_gouvernance
                ->reponses()
