...
class StoreRequest extends FormRequest
{
    ...
    {
        return request()->user()->hasPermissionTo("creer-un-critere-de-gouvernance") || request()->user()->hasRole("unitee-de-gestion");
    }
    ...
    {
        return [
            'nom'           => ['required', 'string', Rule::unique('criteres_de_gouvernance_factuel', 'nom')->where("programmeId", auth()->user()->programmeId)->whereNull('deleted_at')],
