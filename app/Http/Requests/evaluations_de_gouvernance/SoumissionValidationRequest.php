...
class SoumissionValidationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'response_data.factuel.*.sourceDeVerificationId'        => [Rule::requiredIf(!request()->input('response_data.factuel.*.sourceDeVerification')), 'distinct', new HashValidatorRule(new SourceDeVerification())], 
            ...
            'response_data.perception.*.indicateurDeGouvernanceId'      => [Rule::requiredIf(!request()->input('response_data.factuel')), 'distinct',
                new HashValidatorRule(new QuestionDeGouvernance()), 
                function($attribute, $value, $fail) {
