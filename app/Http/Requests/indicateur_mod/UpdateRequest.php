...
class UpdateRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        return $user->hasRole("unitee-de-gestion") || ($user->hasRole("mod") && $this->indicateur->modId == $user->mod->id);
    }
    ...
    {
        $uniteeMesure = Unitee::findByKey($this->uniteeMesureId);

        $categorie = Categorie::findByKey($this->categorieId);

        $mod = MOD::findByKey($this->modId);
