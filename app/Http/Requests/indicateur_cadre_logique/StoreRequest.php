...
class StoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'sourceDeVerification.required'     => "Veuillez préciser la source de vérification de l'indicateur.",
            'hypothese.required'                => "Veuillez préciser l'hypothèse de l'indicateur.",
            'type.required'                     => 'Veuillez préciser le type d\'indicateur.',
            'type.in'                           => "Veuillez préciser un type d'indicateur se trouvant dans cette liste 'programme','projet','resultat','objectif_speficique'.",
        ];
    }
}
