...
class EvaluationsDeGouvernanceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'pourcentage_evolution_des_soumissions_de_perception_for_organisation' => $this->when($user->hasRole('organisation'), function() use ($user){
                return $user->profilable->getPerceptionSubmissionsCompletionAttribute($this->id);
            }),
            'auuth' => $user,
