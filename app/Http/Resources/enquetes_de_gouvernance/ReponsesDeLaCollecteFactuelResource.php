...
class ReponsesDeLaCollecteFactuelResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'point' => $this->point,
            "preuveIsRequired" => $this->option_de_reponse->preuveIsRequired,
            "sourceIsRequired" => $this->option_de_reponse->sourceIsRequired,
            "descriptionIsRequired" => $this->option_de_reponse->descriptionIsRequired,
