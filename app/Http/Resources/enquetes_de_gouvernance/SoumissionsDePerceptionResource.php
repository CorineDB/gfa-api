...
class SoumissionsDePerceptionResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'reponses_de_la_collecte'   => ReponsesDeLaCollecteDePerceptionResource::collection($this->reponses_de_la_collecte),
