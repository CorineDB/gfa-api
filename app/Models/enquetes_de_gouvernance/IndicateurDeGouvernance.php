...
{
    protected $table = 'indicateurs_de_gouvernance_factuel';
    ...
    {
        return $this->belongsToMany(OptionDeReponseGouvernance::class,'indicateur_options_de_reponse', 'indicateurId', 'optionId')->wherePivotNull('deleted_at');
    }
