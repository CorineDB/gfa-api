            ...
            */
            ...
            if(isset($attributs['responsables']['organisations'])){
                ...
                foreach ($attributs['responsables']['organisations'] as $key => $organisation_responsable) {
                    ...
                    $responsables = array_push($responsables, [$organisation->id => ["responsableable_type" => Organisation::class, "programmeId" => $attributs["programmeId"], "created_at" => now(), "updated_at" => now()]]);

                    return response()->json(['statut' => 'success', 'message' => null, 'data' => $responsables, 'statutCode' => 500], 500);
