        ...
        try {
            ...
            if(isset($attributs['perception']) && $attributs['perception'] !== null){
                ...
                if($formulaireDeGouvernance->type == 'perception'){
                    ...
                    $categories_de_gouvernance = $test = $formulaireDeGouvernance->categories_de_gouvernance()->whereNotIn('id', $categories_de_gouvernance);

                    dump($categories_de_gouvernance->get());
                    $categories_de_gouvernance->delete();
                    dump($categories_de_gouvernance->get());
                    dump($test->get());

                    $formulaireDeGouvernance->categories_de_gouvernance()->whereNotIn('id', $categories_de_gouvernance)->get() ->delete();
