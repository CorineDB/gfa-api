...
class PlanDecaissementService extends BaseService implements PlanDecaissementServiceInterface
{
    ...
    public function create(array $attributs) : JsonResponse
    {
        ...
        try
        {
            ...
            if($nombreDeTrimestre === 0) $max = 0;
            else $max = max($trimestres->all());

            if($nombreDeTrimestre == 0 && $attributs['trimestre'] > 1) throw new Exception("Vous devez d'abord faire le plan du premier trimestre", 500);
