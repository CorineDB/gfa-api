...
class ProjetService extends BaseService implements ProjetServiceInterface
{
    ...
    public function update($projetId, array $attributs): JsonResponse
    {
        ...
        try {
            ...
            throw new \Exception("PROJET : " .$projet);
    ...
    public function statistiques($id)
    {
        ...
        try {
            ...
            $stats = [
                ...
                "sites" => $projet->sites,
                "equipes" => UserResource::collection(User::where('programmeId', $projet->programme->id)->where('profilable_type', get_class(new  UniteeDeGestion()))->where('profilable_id', $projet->programme->uniteeDeGestion->profilable->id)->
