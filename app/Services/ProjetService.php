...
class ProjetService extends BaseService implements ProjetServiceInterface
{
    ...
    public function mesure_rendement($id) : JsonResponse
    {
        try
        {
            ...
            return response()->json(['statut' => 'success', 'message' => null, 'data' => $cadre_de_mesure_rendement/* MesureRendementProjetResource::collection($cadre_de_mesure_rendement) */, 'statutCode' => Response::HTTP_OK], Response::HTTP_OK);
