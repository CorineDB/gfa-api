        ...
        try {
            ...
            if ($soumission) {
                ...
                if ($currentSubmissionsCount >= $quota) {
                    return response()->json(['statut' => 'error', 'message' => "Le nombre maximal de soumissions COMPLÉTÉES pour cette évaluation a été atteint. Merci de votre intérêt.", 'data' => ['terminer' => true, 'formulaire_de_gouvernance' => null], 'statutCode' => Response::HTTP_PARTIAL_CONTENT], Response::HTTP_PARTIAL_CONTENT);
                }
