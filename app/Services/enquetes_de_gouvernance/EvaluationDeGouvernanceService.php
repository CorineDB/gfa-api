        ...
        try {
            ...
            if (isset($attributs['formulaires_de_gouvernance'])) {
                ...
                if ($evaluationDeGouvernance->statut == -1) {
                    ...
                    if (isset($formulaires['perception'])) {
                        if ($evaluationDeGouvernance->soumissionsPerception->count() == 0) {
                            $evaluationDeGouvernance->formulaires_de_perception_de_gouvernance()->syncWithoutDetaching([$formulaires['perception']]);
                        }
                    }
                }
            ...
            return response()->json(['statut' => 'success', 'message' => "Enregistrement réussir", 'data' => ($evaluationDeGouvernance), 'statutCode' => Response::HTTP_CREATED], Response::HTTP_CREATED);
        } catch (\Throwable $th) {
